...
pub use config::{
    ...
    DEFAULT_INITIAL_DIFFICULTY, DEFAULT_JOB_RETENTION_MS, DEFAULT_MIN_RETAINED_JOBS,
    DEFAULT_POOL_IDENTIFIER, DEFAULT_STALE_GRACE_MS, DEFAULT_TARGET_SHARES_PER_MINUTE,
    DEFAULT_VERSION_ROLLING_MASK, EXTRANONCE2_SIZE,
};
